...
if __name__ == "__main__":
    ...
    #storage_path = "ray_results/uam_env/DQN_UAM/DQN_trained/checkpoint_000005/checkpoint-5"
    storage_path = cwd + "/ray_results/uam_env/DQN_UAM/DQN_trained_3/checkpoint_000122"
    #storage_path = cwd + "/ray_results/uam_env/DQN_UAM/DQN_trained/checkpoint_000000"
    ...
    for i in range(num_trials):
        ...
        while not done:
            ...
            if reward == env.terminal_reward and done:
                num_success += 1
        #     elif env.vehicle.crashed:
        #         break
        #     # else:
        #     #     break
